    ...
    <div class="panel">
      ...
      <div class="panel-desc">
        <ul class="panel-list">
          ...
          <li>
            ...
            <br />
            <em>useModalRef</em>로 <em>Ref</em>(Vue의 Ref와는 관련 없음)를 사용할 수 있고,
      ...
      <div class="panel-desc">
        ...
        <ul class="panel-list">
          <li>
            JdModalService
            <em>observeModalState</em>: 열려있는 모달의 수 등 서비스 상태 변경을 감지할 수 있습니다.
          </li>
          <li>
            JdModalRef
            <em>observeClosed</em>: 모달 컴포넌트가 닫힐 때를 감지하고 모달 컴포넌트에서 전달하는
            결과를 받을 수 있습니다.
          </li>
          <li>
            JdModalRef
            <em>observeOpener</em>: 모달 컴포넌트가 열리거나 닫히는 상태를 감지할 수 있습니다.
          </li>
        </ul>
      </div>
      ...
      <div class="panel-desc">
        <p class="pg">
          ...
          <em>JdModalRef</em>이 공급(provide) 되어 있고, <em>useJdModalRef</em>로 주입(inject)하여
          사용할 수 있습니다.
          <br />
